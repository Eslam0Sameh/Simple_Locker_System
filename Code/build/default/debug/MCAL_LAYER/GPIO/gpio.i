...
# 11 "MCAL_LAYER/GPIO/gpio.h"
# 1 "MCAL_LAYER/GPIO/gpio_config.h" 1
# 11 "MCAL_LAYER/GPIO/gpio.h" 2
...
# 1 "MCAL_LAYER/GPIO/../../MCAL_LAYER/std_libs.h" 1
# 11 "MCAL_LAYER/GPIO/../../MCAL_LAYER/std_libs.h"
...
# 11 "MCAL_LAYER/GPIO/../../MCAL_LAYER/std_libs.h" 2
...
# 12 "MCAL_LAYER/GPIO/../../MCAL_LAYER/std_libs.h" 2
...
# 13 "MCAL_LAYER/GPIO/../../MCAL_LAYER/std_libs.h" 2
# 14 "MCAL_LAYER/GPIO/gpio.h" 2

# 1 "MCAL_LAYER/GPIO/../compiler.h" 1
# 34 "MCAL_LAYER/GPIO/../compiler.h"
...
# 34 "MCAL_LAYER/GPIO/../compiler.h" 2
# 15 "MCAL_LAYER/GPIO/gpio.h" 2

# 1 "MCAL_LAYER/GPIO/../../MCAL_LAYER/configuration.h" 1
...
STD_RETURN gpio_pin_direction_initialize(const pin_config * ptr){
    ...
    STD_RETURN ret=0X00;
    if((ptr->port_index>=5)||(ptr->pin_index>=8)||(((void*)0)==ptr))
    {
        ret=0X00;
    }
    else
    {
        if((ptr->direction)==INPUT){
            (*TRIS_REG[ptr->port_index]|=(0X01<<ptr->pin_index));
        }
        else{
            (*TRIS_REG[ptr->port_index]&=~(0X01<<ptr->pin_index));
        }
...
STD_RETURN gpio_pin_direction_read(const pin_config * ptr,direction_t * ptr1){
    ...
    STD_RETURN ret= 0X00 ;
    if((ptr->port_index>=5)||(ptr->pin_index>=8)||(((void*)0)==ptr)||(((void*)0)==ptr1)){ret=0X00 ;}
    else
    {

        *ptr1=((*LAT_REG[ptr->port_index] >> ptr->pin_index) & 0X01);
        ret=0X01;
    }
    return ret;
}
...
STD_RETURN ret=0X00;
    ...
    {
        if(logic==HIGH){(*LAT_REG[ptr->port_index]|=(0X01<<ptr->pin_index));}
        else{(*LAT_REG[ptr->port_index]&=~(0X01<<ptr->pin_index));}
        ret=0X01;
    }
    return ret;
}
    STD_RETURN gpio_pin_toggle(const pin_config * ptr){
    STD_RETURN ret=0X00;
    if((ptr->port_index>=5)||(ptr->pin_index>=8)||(((void*)0)==ptr)){ret=0X00 ;}
    else
    {
    ...
    else
    {
        ...
        *ptr1=((*PORT_REG[ptr->port_index] >> ptr->pin_index) & 0X01);
        ret=0X01;
    }
    return ret;
    }
